...
class MDHeader:
    ...
    __slots__ = ("magic_number", "length", "seq_num", "timestamp", "msg_type")
    ...
    def __repr__(self) -> str:
        return (
            f"MDHeader(magic={self.magic_number:016x}, length={self.length}, "
...
class NewOrder:
    ...
    __slots__ = ("header", "order_id", "symbol", "side", "quantity", "price", "flags")
    ...
    def __init__(self, data) -> None:
        ...
        unpacked = struct.unpack(
            self.BODY_FORMAT, data[body_start : body_start + self.BODY_SIZE]
        )
    ...
    def __repr__(self) -> str:
        return (
            f"NewOrder(order_id={self.order_id}, symbol={self.symbol}, "
...
class ModifyOrder:
    ...
    __slots__ = ("header", "order_id", "side", "quantity", "price")
    ...
    def __repr__(self) -> str:
        return (
            f"ModifyOrder(order_id={self.order_id}, side={self.side.name}, "
...
class Trade:
    ...
    __slots__ = ("header", "order_id", "quantity", "price")
    ...
    def __repr__(self) -> str:
        return (
            f"Trade(order_id={self.order_id}, quantity={self.quantity}, "
            f"price={self.price})"
        )
...
class TradeSummary:
    ...
    __slots__ = ("header", "symbol", "aggressor_side", "total_quantity", "last_price")
    ...
    def __repr__(self) -> str:
        return (
            f"TradeSummary(symbol={self.symbol}, aggressor_side={self.aggressor_side.name}, "
...
class SnapshotInfo:
    ...
    __slots__ = ("header", "symbol", "bid_count", "ask_count", "last_md_seq_num")
    ...
    def __repr__(self) -> str:
        return (
            f"SnapshotInfo(symbol={self.symbol}, bid_count={self.bid_count}, "
